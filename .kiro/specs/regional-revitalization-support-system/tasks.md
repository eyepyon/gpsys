...
- [ ] 2.1 地理空間検索の距離制約・順序性・件数制約のプロパティテストを作成する
...
- [ ] 2.2 地理空間検索の入力検証と副作用なしの単体テストを作成する
...
- [ ] 3.1 ベクトル検索の類似度順序性・件数制約のプロパティテストを作成する
...
- [ ] 4.1 ハイブリッド検索の一意性・件数制約・地理的整合性のプロパティテストを作成する
...
- [ ] 5.3 登録の往復性（round-trip）のプロパティテストを作成する
...
- [ ] 7.1 SQLメタ文字を含む入力に対するプロパティテストを作成する
...
- [ ] 8. Cloud SQL for PostgreSQL用リポジトリ実装とスキーマ定義
...
- [ ] 11. 推論サービス（InferRun）のFastAPIエンドポイント実装
...
- [ ]* 14.1 place_id一意性のプロパティテストを作成する
...
- [ ]* 15.1 廃業時期推定レンジ整合性のプロパティテストを作成する
...
- [ ]* 16.1 居抜き物件検索の地理的整合性・業種フィルタ・件数制約のプロパティテストを作成する
...
- [ ]* 17.1 同期処理の部分失敗許容・冪等性の単体テスト/プロパティテストを作成する
...
- [ ] 18. Cloud SQL用VacantPropertyRepository実装とスキーマ定義
...
- [ ] 19. 居抜き物件同期サービス（Cloud Run Jobs）のエントリポイント実装
...
- [ ] 20. アプリ本体サービスへの居抜き物件検索APIエンドポイント追加
